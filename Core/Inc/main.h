...
#define LED_RED_L_GPIO_Port GPIOA
#define MOTOR3_Pin GPIO_PIN_10
#define MOTOR3_GPIO_Port GPIOB
#define LED_BLUE_L_Pin GPIO_PIN_12
#define LED_BLUE_L_GPIO_Port GPIOB
#define MOTOR2_Pin GPIO_PIN_6
#define MOTOR2_GPIO_Port GPIOB
#define MOTOR1_Pin GPIO_PIN_7
#define MOTOR1_GPIO_Port GPIOB
#define MODULE_POWER_Pin GPIO_PIN_0
#define MODULE_POWER_GPIO_Port GPIOB
#define MODULE_DETECT_Pin GPIO_PIN_1
#define MODULE_DETECT_GPIO_Port GPIOB
#define MODULE_SHARED_DATA_Pin GPIO_PIN_4
#define MODULE_SHARED_DATA_GPIO_Port GPIOB
#define MODULE_SHARED_SCL_Pin GPIO_PIN_8
#define MODULE_SHARED_SCL_GPIO_Port GPIOA
